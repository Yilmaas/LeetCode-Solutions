This question can be solved by brute force but time complexity = O(n^2)
But the efficient solution would be to use a hash set instead of comparing every pair
